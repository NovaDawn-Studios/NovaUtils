...
namespace NovaDawnStudios.NovaUtils.Editor
{
    /// <summary>
    ///     Provides additional Gizmos to aid in Editor development.
    /// </summary>
    public class AdvancedGizmos : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Renders a boxy humanoid of roughly correct proportions. This can be used for sizing and highlighting areas where humanoids
        ///     may be created, for example.
        /// </summary>
        /// <param name="position">The position to draw the humanoid, relative to the current <see cref="Gizmos.matrix"/>.</param>
        /// <param name="height">
        ///     The height of the humanoid in Unity units. The default is 1.8 units, corresponding to roughly 1.8 metres if the game uses
        ...
        /// <summary>
        ///     Renders a 'grip', a pistol-like object with the center of the grip being (0,0,0) of the current matrix and the barrel pointing down 
        ///     positive Z. This can be useful for positioning and orientating game objects assets into hands or on surfaces when the actual mesh will only 
        ///     be spawned in at run-time.
        /// </summary>
